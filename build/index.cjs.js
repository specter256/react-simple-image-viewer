...
const ReactSimpleImageViewer = (props) => {
    ...
    const dataLength = React.useMemo(() => props.src.length, [props.src]);
    ...
    return (React__default['default'].createElement("div", { id: "ReactSimpleImageViewer", className: `${styles.wrapper} react-simple-image-viewer__modal`, onKeyDown: handleKeyDown, onClick: handleClick, style: props.backgroundStyle },
        React__default['default'].createElement("span", { className: `${styles.close} react-simple-image-viewer__close`, onClick: () => { var _a; return (_a = props.onClose) === null || _a === void 0 ? void 0 : _a.call(props); } }, props.closeComponent || "×"),
        dataLength > 1 && (React__default['default'].createElement("span", { className: `${styles.navigation} ${styles.prev} react-simple-image-viewer__previous`, onClick: () => changeImage(-1) }, props.leftArrowComponent || "❮")),
        dataLength > 1 && (React__default['default'].createElement("span", { className: `${styles.navigation} ${styles.next} react-simple-image-viewer__next`, onClick: () => changeImage(1) }, props.rightArrowComponent || "❯")),
        React__default['default'].createElement("div", { className: `${styles.content} react-simple-image-viewer__modal-content`, onClick: handleClick },
        ...
        props.showCounter && (React__default['default'].createElement("div", { className: `react-simple-image-viewer__counter` }, props.counterComponent || React__default['default'].createElement("div", { className: styles.counter },
            currentIndex,
            " / ",
            dataLength)))));
};
